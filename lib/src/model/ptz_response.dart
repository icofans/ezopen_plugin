class EZPtzResponse {
  EZPtzResponseData? data;
  String? code;
  String? msg;

  EZPtzResponse({this.data, this.code, this.msg});

  EZPtzResponse.fromJson(Map<String, dynamic> json) {
    data =
        json['data'] != null ? EZPtzResponseData.fromJson(json['data']) : null;
    code = json['code'];
    msg = json['msg'];
  }
...
class EZPtzResponseData {
  ...
  EZPtzResponseData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['video_quality_capacity'] != null) {
      videoQualityCapacity = <EZVideoQualityCapacity>[];
      json['video_quality_capacity'].forEach((v) {
        videoQualityCapacity?.add(EZVideoQualityCapacity.fromJson(v));
      });
    }
...
class EZVideoQualityCapacity {
  ...
  EZVideoQualityCapacity.fromJson(Map<String, dynamic> json) {
